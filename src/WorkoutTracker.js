...
export default function WorkoutTracker() {
  ...
  const [exercises, setExercises] = useState([
    ...
    { week: 'Week 1', day: 'Day 2 - Lower Body (No Barbell)', name: 'Walking Lunges', reps: '10/leg', sets: '3', weight: '', link: 'https://workoutlabs.com/exercise-guide/dumbbell-walking-lunge/' },
